...
jQuery(document).ready(function () {
  ...
  jQuery(".skin-1").on("click", function () {
    ...
    jQuery(".footer-dark .footer-logo img").attr(
      "src",
      "images/logo-1-light.png"
    );
    jQuery(".footer-light .footer-logo img").attr("src", "images/logo-1.png");
    jQuery(".header-style-2 .logo-header-inner img").attr(
      "src",
      "images/logo-1-light.png"
    );
    jQuery(".header-style-3 .logo-header-inner img").attr(
      "src",
      "images/logo-1-light.png"
    );
    return false;
